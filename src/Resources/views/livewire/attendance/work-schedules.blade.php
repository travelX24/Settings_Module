...
@section('topbar-left-content')
    <x-ui.page-header :title="tr('Work Schedules Settings')" :subtitle="tr('Define and manage flexible working hour templates for your organization')"
...
<div class="space-y-6">
    <x-ui.card>
        <div class="space-y-4">
            ...
            <div x-data="{ open: true }" class="space-y-3">
                ...
                <div x-show="open" x-transition class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 items-end">
                    ...
                    <x-ui.filter-select model="filterExceptions" :label="tr('Exceptions')" :placeholder="tr('All')"
                        :options="[
    ...
    <template x-teleport="body">
        <x-ui.confirm-dialog id="schedule-delete" confirmText="{{ tr('Yes, Delete') }}"
            cancelText="{{ tr('Cancel') }}" confirmAction="wire:deleteSchedule(__ID__)"
